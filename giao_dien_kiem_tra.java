...
public class giao_dien_kiem_tra extends JFrame {
	...
	public giao_dien_kiem_tra() {
		...
		comboBox.setBorder(new LineBorder(new Color(100, 149, 237), 2, true));
		...
		lblNewLabel_3.setDisabledIcon(new ImageIcon("D:\\Download\\Hinh_Anh\\cro1.png"));
		lblNewLabel_3.setIcon(new ImageIcon("D:\\Download\\Hinh_Anh\\cro1.png"));
		lblNewLabel_3.setBounds(6, 649, 120, 113);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_2_2 = new JLabel("");
		lblNewLabel_2_2.setIcon(new ImageIcon("D:\\Download\\Hinh_Anh\\may.png"));
		lblNewLabel_2_2.setBounds(71, 305, 64, 64);
		contentPane.add(lblNewLabel_2_2);
		
		JLabel lblNewLabel_2_3 = new JLabel("");
		lblNewLabel_2_3.setIcon(new ImageIcon("D:\\Download\\Hinh_Anh\\may4.png"));
		lblNewLabel_2_3.setBounds(593, 518, 64, 64);
		contentPane.add(lblNewLabel_2_3);
		
		JLabel lblNewLabel_2_3_1 = new JLabel("");
		lblNewLabel_2_3_1.setIcon(new ImageIcon("D:\\Download\\Hinh_Anh\\may2.png"));
		lblNewLabel_2_3_1.setBounds(-6, 475, 64, 64);
		contentPane.add(lblNewLabel_2_3_1);
		
		JLabel lblNewLabel_2_3_2 = new JLabel("");
		lblNewLabel_2_3_2.setIcon(new ImageIcon("D:\\Download\\Hinh_Anh\\may1.png"));
